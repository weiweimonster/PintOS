...
struct thread {
  ...
  /* Owned by thread.c. */
  struct list map_fd_files;   /* mapping between fd and files */
  struct list unused_fd;      
  int curr_fd;                /* keeping trach of current fd number*/
  unsigned magic;             /* Detects stack overflow. */
};
struct lock file_lock;

/* The entry structure fo each map_fd_files*/
typedef struct fd_file_entry{
  int fd;
  void* file;
